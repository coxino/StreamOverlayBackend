...
namespace JWTManager
{
    ...
    public class JwtManager
    {
        ...
        public static async Task<ValidationModel> ValidateTokenAsync(string token, ApplicationDbContext _context)
        {
            ...
            {
                return new ValidationModel() { UserName = userAccount.Username, ValidationResponse = ValidationResponse.SubscriptionExpired };
            }

            return new ValidationModel() { UserName = userName, ValidationResponse = ValidationResponse.Success };
        }
    }
}
